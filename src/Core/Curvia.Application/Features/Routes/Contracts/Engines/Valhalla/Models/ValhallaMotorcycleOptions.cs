...
/// <param name="UseFerry">Preference for ferry crossings. 0.0 = avoid, 1.0 = allow.</param>
/// <param name="TopSpeed">Optional speed cap in km/h. Null = no cap.</param>
public sealed record ValhallaMotorcycleOptions(double UseHighways, double UseTolls, double UseTrails, double UseLivingStreets, double UseFerry = 1.0, double? TopSpeed = null);