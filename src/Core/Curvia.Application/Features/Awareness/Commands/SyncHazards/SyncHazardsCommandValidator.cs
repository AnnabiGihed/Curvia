...
/// Author      : Gihed Annabi
/// Date        : 02-2026
/// Purpose     : FluentValidation validator for <see cref="SyncHazardsCommand"/>.
///              Validates that CountryCode is a non-empty two-character ISO 3166-1 alpha-2 code.
/// </summary>
internal sealed class SyncHazardsCommandValidator : AbstractValidator<SyncHazardsCommand>
{
	/// <summary>
	/// Initialises rules for <see cref="SyncHazardsCommand"/>.
	/// </summary>
	public SyncHazardsCommandValidator()
	{
